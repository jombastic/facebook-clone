...
<template>
    ...
    >
        <div class="grid h-screen place-items-center p-4">
            <div
                class="bg-white w-full max-w-[37.5rem] mx-auto shadow-xl rounded-xl"
            >
                    ...
                    <div class="p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                >
                                    <Earth :size="18" />
                                    <span
                                        class="font-bold pl-1.5 text-[.8125rem]"
                                        >Public</span
                                    >
                                    <ChevronDown
                                        class="pr-10 pl-1"
                        ...
                        <div class="max-h-[21.875rem] overflow-auto">
                            <textarea
                                ...
                                cols="30"
                                rows="3"
                                class="w-full border-0 mt-4 focus:ring-0 text-[1.375rem]"
